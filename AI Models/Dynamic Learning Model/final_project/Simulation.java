...
class Simulation {
    ...
    public Simulation(Environment wumpusEnvironment, int maxSteps, BufferedWriter outWriter, boolean nonDeterministic,
        ...
        try {
            ...
            if (printStuff) {
                System.out.println("Current score: " + currScore*(-1));
                outputWriter.write("Current score: " + currScore*(-1) + "\n");
            }
    ...
    public void printEndWorld() {
        ...
        try {
            ...
            System.out.println("Final score: " + currScore*(-1));
            outputWriter.write("Final score: " + currScore*(-1) + "\n");
